...
// Si ya hay sesión activa → redirigir al dashboard según rol
if (isset($_SESSION['usuario_id']) && !empty($_SESSION['usuario_id'])) {
    $rolActivo = $_SESSION['rol'] ?? 'admin';
    switch ($rolActivo) {
        case 'cobrador':   header('Location: cobrador/dashboard.php');   break;
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            switch ($user['rol']) {
                case 'cobrador':
                    ...
                    $_SESSION['cobrador_portal_nombre'] = $user['usuario'];
                ...
                case 'vendedor':
                    ...
                    $_SESSION['vendedor_portal_nombre'] = $user['usuario'];
                ...
                case 'supervisor':
                    ...
                    $_SESSION['supervisor_portal_nombre'] = $user['usuario'];
